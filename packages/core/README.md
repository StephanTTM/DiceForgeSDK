...
- **Presentation-ready**: pair with [`@diceforge-sdk/renderer-web`](https://www.npmjs.com/package/@diceforge-sdk/renderer-web) for 3D dice, or implement the `InteractionPresenter` contract yourself.
