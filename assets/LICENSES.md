...
- **Notes:** covers every shape the SDK resolves, including the d10 and d12 the KayKit pack lacks, plus a coin whose two faces are textured separately and a 00–90 tens atlas for percentile rolls. Five colours: ivory, red, blue, green, yellow. Glyphs are rendered with DejaVu Sans Bold at generation time; only the resulting images are redistributed, not the font.
